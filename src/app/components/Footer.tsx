  ...
  return (
    <>
      <footer className="lg:w-full lg:h-[243px] lg:absolute lg:top-[2200px] lg:pb-[-3rem] xs:absolute xs:top-[2500px] md:absolute md:top-[1700px] xsm:relative xsm:top-[2400px]">
        ...
        <p className="font-heebo lg:text-[20px] font-semibold lg:leading-[32.31px] text-center text-black lg:mt-[30px] lg:pr-[2rem] xs:text-[13px] xs:mt-[20px] xs:pr-[3rem] xs:pl-[3rem] lg:pl-0 lg:ml-[0rem] md:pl-[18rem] xsm:pl-[4rem] sm:pl-[5rem] ms:pl-[4.5rem]">
